...
const PRESETS: Record<string, Partial<ThemeConfig>> = {
  ...
  "Monokai Pro": { background: '#2d2a2e', sidebarBackground: '#221f22', headerBackground: '#221f22', cardBackground: '#363236', accent: '#ffd866', border: '#423f43', textPrimary: '#fcfcfa', textSecondary: '#939293', bgType: 'solid', borderRadius: '8px' },
  "Solarized Dark": { background: '#002b36', sidebarBackground: '#073642', headerBackground: '#073642', cardBackground: '#073642', accent: '#268bd2', border: '#094656', textPrimary: '#839496', textSecondary: '#586e75', bgType: 'solid', borderRadius: '6px' },
  "Material Darker": { background: '#212121', sidebarBackground: '#1a1a1a', headerBackground: '#1a1a1a', cardBackground: '#292929', accent: '#82aaff', border: '#2e2e2e', textPrimary: '#eeffff', textSecondary: '#616161', bgType: 'solid', borderRadius: '4px' },
  "Nord": { background: '#2e3440', sidebarBackground: '#3b4252', headerBackground: '#3b4252', cardBackground: '#3b4252', accent: '#88c0d0', border: '#434c5e', textPrimary: '#eceff4', textSecondary: '#d8dee9', bgType: 'solid', borderRadius: '8px' },
  "Gruvbox Dark": { background: '#282828', sidebarBackground: '#1d2021', headerBackground: '#1d2021', cardBackground: '#3c3836', accent: '#fe8019', border: '#504945', textPrimary: '#ebdbb2', textSecondary: '#a89984', bgType: 'solid', borderRadius: '6px' },
  "Synthwave '84": { background: '#241b2f', sidebarBackground: '#1a1525', headerBackground: '#1a1525', cardBackground: '#2a2139', accent: '#f92aad', border: '#342843', textPrimary: '#ff7edb', textSecondary: '#9d86b3', bgType: 'linear', bgGradientColor: '#1e1629', bgGradientAngle: 135, borderRadius: '12px' },
  "Palenight": { background: '#292d3e', sidebarBackground: '#1e2132', headerBackground: '#1e2132', cardBackground: '#32374d', accent: '#c792ea', border: '#3d4457', textPrimary: '#a6accd', textSecondary: '#676e95', bgType: 'solid', borderRadius: '8px' },
  "Cobalt2": { background: '#193549', sidebarBackground: '#122738', headerBackground: '#122738', cardBackground: '#1f4662', accent: '#ffc600', border: '#0d3a58', textPrimary: '#ffffff', textSecondary: '#9effff', bgType: 'solid', borderRadius: '6px' }
};
